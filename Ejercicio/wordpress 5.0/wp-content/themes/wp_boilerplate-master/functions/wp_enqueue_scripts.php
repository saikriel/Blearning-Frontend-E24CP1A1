...
function dl_enqueue_scripts() {
	...
	wp_register_script( 'main_js', get_theme_file_uri('/assets/js/functions.js'), $deps, null, true );
	wp_register_script( 'script_js', get_theme_file_uri('/assets/js/script.js'), $deps, null, true );
	wp_register_script( 'functions_js', get_theme_file_uri('/assets/js/functions.js'), $deps, null, true );
	wp_register_script( 'custom_js', get_theme_file_uri('/assets/js/custom.js'), $deps, null, true );
	wp_register_script( 'jquery172', get_theme_file_uri('/assets/js/jquery-1.7.2.js'), $deps, null, true );
	wp_register_script( 'jqueryeasing', get_theme_file_uri('/assets/js/jquery.easing.1.3.js'), $deps, null, true );
	wp_register_script( 'jquerynivo', get_theme_file_uri('/assets/js/jquery.nivo.slider.pack.js'), $deps, null, true );
	wp_register_script( 'jquerypretty', get_theme_file_uri('/assets/js/jquery.prettyPhoto.js'), $deps, null, true );
	wp_register_script( 'jqueryquicksand', get_theme_file_uri('/assets/js/jquery.quicksand.js'), $deps, null, true );
	...
	wp_enqueue_script( 'jquery172_js' );
	wp_enqueue_script( 'jqueryeasing' );
	wp_enqueue_script( 'jquerynivo' );
	wp_enqueue_script( 'jquerypretty' );
	wp_enqueue_script( 'jqueryquicksand' );
