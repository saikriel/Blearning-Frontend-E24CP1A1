...
function dl_enqueue_style() {
	...
	wp_register_style( 'ie9.css', get_theme_file_uri( '/assets/css/ie9.css'), array('reset'), $theme_data->get( 'Version' ), 'screen' );
	wp_register_style( 'nivo', get_theme_file_uri( '/assets/css/nivo-slider.css'), array('reset'), $theme_data->get( 'Version' ), 'screen' );
	wp_register_style( 'nivotheme', get_theme_file_uri( '/assets/css/nivotheme.css'), array('reset'), $theme_data->get( 'Version' ), 'screen' );
	wp_register_style( 'pretty', get_theme_file_uri( '/assets/css/prettyPhoto.css'), array('reset'), $theme_data->get( 'Version' ), 'screen' );
